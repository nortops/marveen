...
window._i18n.en = {
  ...
  'fleet.docs.title':             'Documentation',
  'fleet.docs.what_title':        'What does full fleet migration do?',
  'fleet.docs.what_body':         'Creates a single portable JSON of the entire fleet that can be loaded into a fresh installation. Enables machine-to-machine migration without manually reconfiguring all agents and memories.',
  'fleet.docs.carries_title':     'What does the export include?',
  'fleet.docs.carries_1':         'Main agent persona: CLAUDE.md, SOUL.md, agent-config.json, settings, channel pairing',
  'fleet.docs.carries_2':         'Sub-agents: full config, personality, channels, avatars',
  'fleet.docs.carries_3':         'Memories: all agent memory entries (atlas, marveen, sub-agents)',
  'fleet.docs.carries_4':         'Daily log entries',
  'fleet.docs.carries_5':         'Skills: global and agent-level',
  'fleet.docs.carries_6':         'Scheduled tasks (paused: arrive with enabled=false)',
  'fleet.docs.carries_7':         'Kanban board: cards, comments, labels',
  'fleet.docs.carries_8':         'Idea box',
  'fleet.docs.carries_9':         'Dashboard settings (autonomy, auto-restart, preferences)',
  'fleet.docs.carries_10':        'Vault (optional, password-encrypted): MCP secrets, bot tokens',
  'fleet.docs.not_title':         'What is NOT included?',
  'fleet.docs.not_1':             'Google/Gmail/Calendar OAuth sessions: must re-authenticate on target machine',
  'fleet.docs.not_2':             'Dashboard-token: use the target machine own token',
  'fleet.docs.not_3':             'Source code and build artifacts: come from normal install (npm ci, npm run build)',
  'fleet.docs.not_4':             'Telemetry, session logs, conversation history',
  'fleet.docs.dryrun_title':      'Dry-run safety',
  'fleet.docs.dryrun_body':       'The "Check" button only reads the file and shows what would be created, without writing anything. The "Apply" button is only enabled after a successful dry-run and requires a confirmation step.',
  'fleet.docs.vault_title':       'Vault password role',
  'fleet.docs.vault_body':        'If you supply a password at export, MCP secrets and bot tokens are encrypted into the JSON (scrypt+AES-256-GCM). The same password is required at import to decrypt them. Without a password, secrets are omitted and agents require manual token setup after import.',
  'fleet.docs.steps_title':       'Step-by-step',
  'fleet.docs.step_1':            'On the old machine: Export, optionally with vault password. Save the JSON.',
  'fleet.docs.step_2':            'On the new machine: install the dashboard (git clone, npm ci, npm run build, start).',
  'fleet.docs.step_3':            'Browse the JSON, enter vault password (if any), run the Check.',
  'fleet.docs.step_4':            'Review the dry-run summary: agent count, memories, kanban numbers look correct.',
  'fleet.docs.step_5':            'Execute (apply): agents, memories and settings written. Vault secrets decrypted.',
  'fleet.docs.step_6':            'Restart the dashboard, re-authenticate OAuth connections.',
}
