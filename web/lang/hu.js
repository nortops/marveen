...
window._i18n.hu = {
  ...
  'fleet.docs.title':             'Dokumentáció',
  'fleet.docs.what_title':        'Mit csinál a teljes flotta migráció?',
  'fleet.docs.what_body':         'Egyetlen hordozható JSON-t készít a teljes flottáról, amit egy friss telepítésre be lehet tölteni. Segítségével gépek között lehet átköltözni anélkül, hogy az összes ügynököt és memóriát kézzel kellene újrakonfigurálni.',
  'fleet.docs.carries_title':     'Mit visz magával az export?',
  'fleet.docs.carries_1':         'Fő ügynök persona: CLAUDE.md, SOUL.md, agent-config.json, beállítások, csatorna-párosítás',
  'fleet.docs.carries_2':         'Al-ügynökök: teljes konfiguráció, személyiség, csatornák, képek',
  'fleet.docs.carries_3':         'Memóriák: az összes ügynök memóriabejegyzése (atlas, marveen, al-ügynökök)',
  'fleet.docs.carries_4':         'Napi napló bejegyzések',
  'fleet.docs.carries_5':         'Skillek: globális és ügynök-szintű',
  'fleet.docs.carries_6':         'Ütemezett feladatok (szüneteltetve: enabled=false érkeznek)',
  'fleet.docs.carries_7':         'Kanban tábla: kártyák, kommentek, címkék',
  'fleet.docs.carries_8':         'Ötletláda (idea box)',
  'fleet.docs.carries_9':         'Dashboard beállítások (autonómia, auto-restart, preferenciák)',
  'fleet.docs.carries_10':        'Vault (opcionális, jelszóval titkosítva): MCP-titkok, bot-tokenek',
  'fleet.docs.not_title':         'Mit NEM visz magával?',
  'fleet.docs.not_1':             'Google/Gmail/Calendar OAuth bejelentkezések: a célgépen újra kell hitelesíteni',
  'fleet.docs.not_2':             'Dashboard-token: a célgép saját tokenjét kell használni',
  'fleet.docs.not_3':             'Forráskód és build-eredmények: a normál telepítésből jönnek (npm ci, npm run build)',
  'fleet.docs.not_4':             'Telemetria, session-logok, conversation-history',
  'fleet.docs.dryrun_title':      'Dry-run biztonság',
  'fleet.docs.dryrun_body':       'Az "Ellenőrzés" gomb csak beolvassa a fájlt és megmutatja, mi jönne létre, de nem ír semmit a rendszerbe. Az "Apply" gomb csak a dry-run után érhető el, és egy megerősítési lépéssel véd a véletlen felülírás ellen.',
  'fleet.docs.vault_title':       'Vault jelszó szerepe',
  'fleet.docs.vault_body':        'Ha az exportnál megadsz jelszót, az MCP-titkok és bot-tokenek titkosítva kerülnek a JSON-ba (scrypt+AES-256-GCM). Importáláskor ugyanezt a jelszót kell megadni a visszafejtéshez. Jelszó nélkül a titkok kimaradnak, az ügynökök indulás után manuális token-beállítást igényelnek.',
  'fleet.docs.steps_title':       'Lépéssor',
  'fleet.docs.step_1':            'A régi gépen: Export, opcionálisan vault jelszóval. Mentsd el a JSON-t.',
  'fleet.docs.step_2':            'Az új gépen: telepítsd a dashboardot (git clone, npm ci, npm run build, indítás).',
  'fleet.docs.step_3':            'Tallózd be a JSON-t, add meg a vault jelszót (ha volt), futtasd az Ellenőrzést.',
  'fleet.docs.step_4':            'Ellenőrizd a dry-run összefoglalót: ügynökök, memóriák, kanban számai helyesek-e.',
  'fleet.docs.step_5':            'Végrehajtás (apply): az ügynökök, memóriák és beállítások beírva. A vault-titkok visszafejtve.',
  'fleet.docs.step_6':            'Indítsd újra a dashboardot, hitelesítsd újra az OAuth-kapcsolatokat.',
}
